...
\item \href{http://github.com/haxiomic}{I'm a keen proponent of open source} and you can find my contributes under the handle `haxiomic'.
...
\item Imran Aslam of University Hospitals of Leicester commissioned the develeopment of a browser-based e-Learning app.
...
\item \href{https://github.com/haxiomic/supersl}{SuperSL} is a shader programming language built for the web. SuperSL is a superset of GLSL with additional language features designed to resolve some of GLSL shortcomings and improve the process writing shaders for WebGL.
...
\item It's been played with approximately \textbf{2 million times} by \textbf{1.6 million users}
\item It has reached the front page of \href{https://www.reddit.com/r/InternetIsBeautiful/comments/2gkunq/fluid_and_particles_in_webgl/}{Reddit} and featured in articles on
\begin{itemize}
...
% Programming Languages & JavaScript, Haxe, C, GLSL, Objective-C, Bash \\
% Tools & Git \\
% ?Skills & UI \& UX, Frontend Web
% \end{tabular}
