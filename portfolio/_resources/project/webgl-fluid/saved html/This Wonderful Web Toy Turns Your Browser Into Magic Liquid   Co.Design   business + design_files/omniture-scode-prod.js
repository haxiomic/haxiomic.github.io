...
2013-06-18 update s object name
...
//var s_account="gjincfastcoprod"   //need to change that back once we're live on production
var s_account="gjincfastcoprod"
var fastco_s=s_gi(s_account)
/************************** CONFIG SECTION **************************/
/* You may add or alter any code config here. */
fastco_s.charSet="UTF-8"
/* Conversion Config */
fastco_s.currencyCode="USD"
/* Link Tracking Config */
fastco_s.trackDownloadLinks=true
fastco_s.trackExternalLinks=true
fastco_s.trackInlineStats=true
fastco_s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx"
fastco_s.linkInternalFilters="javascript:,fastcompany.com,fastcocreate.com,fastcodesign.com,fastcoexist.com"
fastco_s.linkLeaveQueryString=false
fastco_s.linkTrackVars="None"
fastco_s.linkTrackEvents="None"

/* Form Analysis Config (should be above doPlugins section) */
fastco_s.formList="ICM_iPad_Premium1" //comma delimeted list
fastco_s.trackFormList=true
fastco_s.trackPageName=true
fastco_s.useCommerce=false
fastco_s.varUsed="prop24"
fastco_s.eventList="" //Abandon,Success,Error


/* Plugin Config */
fastco_s.usePlugins=true
function s_doPlugins(s) {

/* JS Version Control */
  fastco_s.prop25=SCCodeVersion;

/* Track External Campaign */
  if(!fastco_s.campaign)
    fastco_s.campaign=fastco_s.getQueryParam('cid') ?
      fastco_s.getQueryParam('cid') :
      fastco_s.getQueryParam('partner');
    fastco_s.campaign=fastco_s.getValOnce(fastco_s.campaign,'s_campaign',0);

/* Campaign Stacking */
  fastco_s.eVar19=fastco_s.crossVisitParticipation(fastco_s.campaign,'s_cpm','30','5','>');

/* Navigation Source */
  fastco_s.prop7=fastco_s.eVar7=fastco_s.getQueryParam('nav');
  fastco_s.eVar7=fastco_s.getValOnce(fastco_s.eVar7,'s_nav',0);

/* Populate Time Parting */
  var currentDate = new Date()
  var year = currentDate.getFullYear()
  fastco_s.prop17=fastco_s.getTimeParting('h','-5',year)+":"+fastco_s.getTimeParting('d','-5',year)+":"+fastco_s.getTimeParting('w','-5',year);
  fastco_s.eVar15="D=c17";

/* New-Returning Visit */
  fastco_s.prop18=fastco_s.getNewRepeat();
  fastco_s.eVar16="D=c18";

/* Get Visit number for duration of the month */
  fastco_s.prop19=fastco_s.getVisitNum('m');
  fastco_s.eVar17="D=c19";
  
/* Days since last visit */
  fastco_s.prop20=fastco_s.getDaysSinceLastVisit('s_lv');
  fastco_s.eVar18="D=c20";
  
/* Set the Hierachy 1 from the Page Name */
  if(fastco_s.prop4 && fastco_s.prop4!=""){
    /* Returns page name as lowercase */
    fastco_s.prop4=fastco_s.prop4.toLowerCase();
    // Sets hierarchy to be equal to the pageName
    fastco_s.hier1="D=pageName";
  }
  
/* Plugin: formAnalysis 2.1  */
  //fastco_s.setupFormAnalysis();

  /* Related Article */
  var relatedArticle = fastco_s.getQueryParam('nav');
  if (relatedArticle == 'rel') {
    fastco_s.prop12=fastco_s.getPreviousValue(fastco_s.prop4,'gpv_p12');
  }
  fastco_s.getPreviousValue(fastco_s.prop4,'gpv_p12','');

  /* Department */
  if(fastco_s.prop1&&!fastco_s.eVar1) fastco_s.eVar1="D=c1";

  /* Topic */
  if(fastco_s.prop2&&!fastco_s.eVar2) fastco_s.eVar2="D=c2";

  /* Story name */
  if(fastco_s.prop3&&!fastco_s.eVar3) fastco_s.eVar3="D=c3";

  /* Content Series */
  if(fastco_s.prop5&&!fastco_s.eVar5) fastco_s.eVar5="D=c5";

  /* Content Package */
  if(fastco_s.prop6&&!fastco_s.eVar6) fastco_s.eVar6="D=c6";

  /* Navigation Source */
  if(fastco_s.prop7&&!fastco_s.eVar7) fastco_s.eVar7="D=c7";

  /* Article Author */
  if(fastco_s.prop8&&!fastco_s.eVar8) fastco_s.eVar8="D=c8";

  /* Article Date */
  if(fastco_s.prop9&&!fastco_s.eVar9) fastco_s.eVar9="D=c9";

  /* Article ID */
  if(fastco_s.prop10&&!fastco_s.eVar10) fastco_s.eVar10="D=c10";

  /* Article Editor */
  if(fastco_s.prop11&&!fastco_s.eVar11) fastco_s.eVar11="D=c11";

  /* Unique Visitor ID */
  fastco_s.eVar29=fastco_s.prop26="D=s_vi";

   /* Track Internal Campaign */
  if(!fastco_s.eVar33)
    fastco_s.eVar33=fastco_s.getQueryParam('icid');
    fastco_s.eVar33=fastco_s.getValOnce(fastco_s.eVar33,'eVar33',0);
  
  /* UTM tracking evars, go to Report Suite Manager in Omniture dashboard for a list of evars */
  if (!fastco_s.eVar51)
    fastco_s.eVar51=fastco_s.getQueryParam('utm_campaign');
    fastco_s.eVar51=fastco_s.getValOnce(fastco_s.eVar51,'eVar51',0);

  if (!fastco_s.eVar52)
    fastco_s.eVar52=fastco_s.getQueryParam('utm_source');
    fastco_s.eVar52=fastco_s.getValOnce(fastco_s.eVar52,'eVar52',0);

  if (!fastco_s.eVar53)
    fastco_s.eVar53=fastco_s.getQueryParam('utm_medium');
    fastco_s.eVar53=fastco_s.getValOnce(fastco_s.eVar53,'eVar53',0);

  if (!fastco_s.eVar54)
    fastco_s.eVar54=fastco_s.getQueryParam('utm_campaign,utm_medium,utm_source','|');
    fastco_s.eVar54=fastco_s.getValOnce(fastco_s.eVar54,'eVar54',0);

  /* Internal Search Term */
  if(fastco_s.prop14&&!fastco_s.eVar12) fastco_s.eVar12="D=c14";

  /* Internal Search # of results */
  if(fastco_s.prop15&&!fastco_s.eVar13) fastco_s.eVar13="D=c15";

  /* Internal Search # of page */
  if(fastco_s.prop16&&!fastco_s.eVar14) fastco_s.eVar14="D=c16";

  /* Log Status */
  if(fastco_s.prop21&&!fastco_s.eVar23) fastco_s.eVar23="D=c21";

  /* Percent Page Viewed */
  fastco_s.prop29=fastco_s.getPercentPageViewed();

  /* Reffering URL */
  if (document.referrer.indexOf("inc.com") < 0) fastco_s.eVar44="D=r";

  /* Newsletter to List Var */
  if(fastco_s.eVar40&&!fastco_s.list1) fastco_s.list1="D=v40";

  /* Ad ID to List Var */
  if(fastco_s.eVar43&&!fastco_s.list2) fastco_s.list2="D=v43";

  /* BP Page Name */
  if(fastco_s.prop4&&!fastco_s.eVar27) fastco_s.eVar27="D=c4";

  /* Page Number */
  if(fastco_s.prop13&&!fastco_s.eVar28) fastco_s.eVar28="D=c13";

  /* Content Type */
  if(fastco_s.prop28&&!fastco_s.eVar35) fastco_s.eVar35="D=c28";
  
}
fastco_s.doPlugins=s_doPlugins

/************************** PLUGINS SECTION *************************/
/*
 * Plugin: getValOnce_v1.0
 */
fastco_s.getValOnce=new Function("v","c","e",""
+"var fastco_s=this,a=new Date,v=v?v:v='',c=c?c:c='s_gvo',e=e?e:0,k=fastco_s.c_r(c"
+");if(v){a.setTime(a.getTime()+e*86400000);fastco_s.c_w(c,v,e?a:0);}return"
+" v==k?'':v");

/*
 * Plugin: getQueryParam 2.3
 */
fastco_s.getQueryParam=new Function("p","d","u",""
+"var fastco_s=this,v='',i,t;d=d?d:'';u=u?u:(fastco_s.pageURL?fastco_s.pageURL:fastco_s.wd.locati"
+"on);if(u=='f')u=fastco_s.gtfs().location;while(p){i=p.indexOf(',');i=i<0?p"
+".length:i;t=fastco_s.p_gpv(p.substring(0,i),u+'');if(t){t=t.indexOf('#')>-"
+"1?t.substring(0,t.indexOf('#')):t;}if(t)v+=v?d+t:t;p=p.substring(i="
+"=p.length?i:i+1)}return v");
fastco_s.p_gpv=new Function("k","u",""
+"var fastco_s=this,v='',i=u.indexOf('?'),q;if(k&&i>-1){q=u.substring(i+1);v"
+"=fastco_s.pt(q,'&','p_gvf',k)}return v");
fastco_s.p_gvf=new Function("t","k",""
+"if(t){var fastco_s=this,i=t.indexOf('='),p=i<0?t:t.substring(0,i),v=i<0?'T"
+"rue':t.substring(i+1);if(p.toLowerCase()==k.toLowerCase())return fastco_s."
+"epa(v)}return ''");
...
fastco_s.crossVisitParticipation=new Function("v","cn","ex","ct","dl","ev","dv",""
+"var fastco_s=this,ce;if(typeof(dv)==='undefined')dv=0;if(fastco_s.events&&ev){var"
+" ay=fastco_s.split(ev,',');var ea=fastco_s.split(fastco_s.events,',');for(var u=0;u<ay.l"
+"ength;u++){for(var x=0;x<ea.length;x++){if(ay[u]==ea[x]){ce=1;}}}}i"
+"f(!v||v==''){if(ce){fastco_s.c_w(cn,'');return'';}else return'';}v=escape("
+"v);var arry=new Array(),a=new Array(),c=fastco_s.c_r(cn),g=0,h=new Array()"
+";if(c&&c!=''){arry=fastco_s.split(c,'],[');for(q=0;q<arry.length;q++){z=ar"
+"ry[q];z=fastco_s.repl(z,'[','');z=fastco_s.repl(z,']','');z=fastco_s.repl(z,\"'\",'');arry"
+"[q]=fastco_s.split(z,',')}}var e=new Date();e.setFullYear(e.getFullYear()+"
+"5);if(dv==0&&arry.length>0&&arry[arry.length-1][0]==v)arry[arry.len"
+"gth-1]=[v,new Date().getTime()];else arry[arry.length]=[v,new Date("
+").getTime()];var start=arry.length-ct<0?0:arry.length-ct;var td=new"
+" Date();for(var x=start;x<arry.length;x++){var diff=Math.round((td."
+"getTime()-arry[x][1])/86400000);if(diff<ex){h[g]=unescape(arry[x][0"
+"]);a[g]=[arry[x][0],arry[x][1]];g++;}}var data=fastco_s.join(a,{delim:',',"
+"front:'[',back:']',wrap:\"'\"});fastco_s.c_w(cn,data,e);var r=fastco_s.join(h,{deli"
+"m:dl});if(ce)fastco_s.c_w(cn,'');return r;");

/*
 * Utility Functions: apl, p_c, p_gh, split, replace, join
 */
//append list
fastco_s.apl=new Function("L","v","d","u","var fastco_s=this,m=0;if(!L)L='';if(u){var i,n,a=fastco_s.split(L,d);for(i=0;i<a.length;i++){n=a[i];m=m||(u==1?(n==v):(n.toLowerCase()==v.toLowerCase()));}}if(!m)L=L?L+d+v:v;return L");

// split v1.5
fastco_s.split=new Function("l","d","var i,x=0,a=new Array;while(l){i=l.indexOf(d);i=i>-1?i:l.length;a[x++]=l.substring(0,i);l=l.substring(i+d.length);}return a");

// ver. 1.0 - fastco_s.join(v,p)| v - Array | p - formatting parameters (front,back,delim,wrap)
fastco_s.join=new Function("v","p","var fastco_s=this;var f,b,d,w;if(p){f=p.front?p.front:'';b=p.back?p.back:'';d=p.delim?p.delim:'';w=p.wrap?p.wrap:'';}var str='';for(var x=0;x<v.length;x++){if(typeof(v[x])=='object' )str+=fastco_s.join( v[x],p);else str+=w+v[x]+w;if(x<v.length-1)str+=d;}return f+str+b;");

/*
 * Plugin Utility: Replace v1.0
 */
fastco_s.repl=new Function("x","o","n",""
+"var i=x.indexOf(o),l=n.length;while(x&&i>=0){x=x.substring(0,i)+n+x."
+"substring(i+o.length);i=x.indexOf(o,i+l)}return x");

// getTimeParting ver. 2.0
fastco_s.getTimeParting=new Function("t","z","y","l", "var fastco_s=this,d,A,U,X,Z,W,B,C,D,Y;d=new Date();A=d.getFullYear();Y=U=String(A);if(fastco_s.dstStart&&fastco_s.dstEnd){B=fastco_s.dstStart;C=fastco_s.dstEnd}else{;U=U.substring(2,4);X='090801|101407|111306|121104|131003|140902|150801|161306|171205|181104|191003';X=fastco_s.split(X,'|');for(W=0;W<=10;W++){Z=X[W].substring(0,2);if(U==Z){B=X[W].substring(2,4);C=X[W].substring(4,6)}}if(!B||!C){B='08';C='01'}B='03/'+B+'/'+A;C='11/'+C+'/'+A;}D=new Date('1/1/2000');if(D.getDay()!=6||D.getMonth()!=0){return'Data Not Available'}else{z=z?z:'0';z=parseFloat(z);B=new Date(B);C=new Date(C);W=new Date();if(W>B&&W<C&&l!='0'){z=z+1}W=W.getTime()+(W.getTimezoneOffset()*60000);W=new Date(W+(3600000*z));X=['Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday'];B=W.getHours();C=W.getMinutes();D=W.getDay();Z=X[D];U='AM';A='Weekday';X='00';if(C>30){X='30'}if(B>=12){U='PM';B=B-12};if(B==0){B=12};if(D==6||D==0){A='Weekend'}W=B+':'+X+U;if(y&&y!=Y){return'Data Not Available'}else{if(t){if(t=='h'){return W}if(t=='d'){return Z}if(t=='w'){return A}}else{return Z+', '+W}}}");

/*
 * Plugin: getNewRepeat 1.1 - Return whether user is new or repeat
 */
fastco_s.getNewRepeat=new Function("d",""
+"var fastco_s=this,e=new Date(),cval,sval,ct=e.getTime();e.setTime(ct+d*24*"
+"60*60*1000);cval=fastco_s.c_r('s_nr');if(cval.length==0){fastco_s.c_w('s_nr',ct+'"
+"-New',e);return 'New';}sval=cval.split('-');if(ct-sval[0]<30*60*100"
+"0&&sval[1]=='New'){fastco_s.c_w('s_nr',ct+'-New',e);return 'New';}else {fastco_s."
 ...
 */
fastco_s.getPreviousValue=new Function("v","c","el",""
+"var fastco_s=this,t=new Date,i,j,r='';t.setTime(t.getTime()+1800000);if(el"
+"){if(fastco_s.events){i=fastco_s.split(el,',');j=fastco_s.split(fastco_s.events,',');for(x in i"
+"){for(y in j){if(i[x]==j[y]){if(fastco_s.c_r(c)) r=fastco_s.c_r(c);v?fastco_s.c_w(c,v,t)"
+":fastco_s.c_w(c,'no value',t);return r}}}}}else{if(fastco_s.c_r(c)) r=fastco_s.c_r(c);v?"
+"fastco_s.c_w(c,v,t):fastco_s.c_w(c,'no value',t);return r}");

/*
 * Utility Function: p_c
 */
fastco_s.p_c=new Function("v","c",""
 ...
 */
fastco_s.getVisitNum=new Function("tp","c","c2",""
+"var fastco_s=this,e=new Date,cval,cvisit,ct=e.getTime(),d;if(!tp){tp='m';}"
+"if(tp=='m'||tp=='w'||tp=='d'){eo=fastco_s.endof(tp),y=eo.getTime();e.setTi"
+"me(y);}else {d=tp*86400000;e.setTime(ct+d);}if(!c){c='s_vnum';}if(!"
+"c2){c2='s_invisit';}cval=fastco_s.c_r(c);if(cval){var i=cval.indexOf('&vn="
+"'),str=cval.substring(i+4,cval.length),k;}cvisit=fastco_s.c_r(c2);if(cvisi"
+"t){if(str){e.setTime(ct+1800000);fastco_s.c_w(c2,'true',e);return str;}els"
+"e {return 'unknown visit number';}}else {if(str){str++;k=cval.substri"
+"ng(0,i);e.setTime(k);fastco_s.c_w(c,k+'&vn='+str,e);e.setTime(ct+1800000);"
+"fastco_s.c_w(c2,'true',e);return str;}else {fastco_s.c_w(c,e.getTime()+'&vn=1',e)"
+";e.setTime(ct+1800000);fastco_s.c_w(c2,'true',e);return 1;}}");
fastco_s.dimo=new Function("m","y",""
+"var d=new Date(y,m+1,0);return d.getDate();");
fastco_s.endof=new Function("x",""
+"var t=new Date;t.setHours(0);t.setMinutes(0);t.setSeconds(0);if(x=="
+"'m'){d=fastco_s.dimo(t.getMonth(),t.getFullYear())-t.getDate()+1;}else if("
 ...
 */
fastco_s.getDaysSinceLastVisit=new Function("c",""
+"var fastco_s=this,e=new Date(),es=new Date(),cval,cval_s,cval_ss,ct=e.getT"
+"ime(),day=24*60*60*1000,f1,f2,f3,f4,f5;e.setTime(ct+3*365*day);es.s"
+"etTime(ct+30*60*1000);f0='Cookies Not Supported';f1='First Visit';f"
+"2='More than 30 days';f3='More than 7 days';f4='Less than 7 days';f"
+"5='Less than 1 day';cval=fastco_s.c_r(c);if(cval.length==0){fastco_s.c_w(c,ct,e);"
+"fastco_s.c_w(c+'_s',f1,es);}else{var d=ct-cval;if(d>30*60*1000){if(d>30*da"
+"y){fastco_s.c_w(c,ct,e);fastco_s.c_w(c+'_s',f2,es);}else if(d<30*day+1 && d>7*day"
+"){fastco_s.c_w(c,ct,e);fastco_s.c_w(c+'_s',f3,es);}else if(d<7*day+1 && d>day){fastco_s."
+"c_w(c,ct,e);fastco_s.c_w(c+'_s',f4,es);}else if(d<day+1){fastco_s.c_w(c,ct,e);fastco_s.c"
+"_w(c+'_s',f5,es);}}else{fastco_s.c_w(c,ct,e);cval_ss=fastco_s.c_r(c+'_s');fastco_s.c_w(c"
+"+'_s',cval_ss,es);}}cval_s=fastco_s.c_r(c+'_s');if(cval_s.length==0) retur"
 ...
 */
fastco_s.setupFormAnalysis=new Function(""
+"var fastco_s=this;if(!fastco_s.fa){fastco_s.fa=new Object;var f=fastco_s.fa;f.ol=fastco_s.wd.onload;fastco_s."
+"wd.onload=fastco_s.faol;f.uc=fastco_s.useCommerce;f.vu=fastco_s.varUsed;f.vl=f.uc?fastco_s.even"
+"tList:'';f.tfl=fastco_s.trackFormList;f.fl=fastco_s.formList;f.va=new Array('',''"
+",'','')}");
fastco_s.sendFormEvent=new Function("t","pn","fn","en",""
+"var fastco_s=this,f=fastco_s.fa;t=t=='s'?t:'e';f.va[0]=pn;f.va[1]=fn;f.va[3]=t=='"
+"s'?'Success':en;fastco_s.fasl(t);f.va[1]='';f.va[3]='';");
fastco_s.faol=new Function("e",""
+"var fastco_s=s_c_il["+fastco_s._in+"],f=fastco_s.fa,r=true,fo,fn,i,en,t,tf;if(!e)e=fastco_s.wd."
+"event;f.os=new Array;if(f.ol)r=f.ol(e);if(fastco_s.d.forms&&fastco_s.d.forms.leng"
+"th>0){for(i=fastco_s.d.forms.length-1;i>=0;i--){fo=fastco_s.d.forms[i];fn=fo.name"
+";tf=f.tfl&&fastco_s.pt(f.fl,',','ee',fn)||!f.tfl&&!fastco_s.pt(f.fl,',','ee',fn);"
+"if(tf){f.os[fn]=fo.onsubmit;fo.onsubmit=fastco_s.faos;f.va[1]=fn;f.va[3]='"
+"No Data Entered';for(en=0;en<fo.elements.length;en++){el=fo.element"
+"s[en];t=el.type;if(t&&t.toUpperCase){t=t.toUpperCase();var md=el.on"
+"mousedown,kd=el.onkeydown,omd=md?md.toString():'',okd=kd?kd.toStrin"
+"g():'';if(omd.indexOf('.fam(')<0&&okd.indexOf('.fam(')<0){el.s_famd"
+"=md;el.s_fakd=kd;el.onmousedown=fastco_s.fam;el.onkeydown=fastco_s.fam}}}}}f.ul=s"
+".wd.onunload;fastco_s.wd.onunload=fastco_s.fasl;}return r;");
fastco_s.faos=new Function("e",""
+"var fastco_s=s_c_il["+fastco_s._in+"],f=fastco_s.fa,su;if(!e)e=fastco_s.wd.event;if(f.vu){s[f.v"
+"u]='';f.va[1]='';f.va[3]='';}su=f.os[this.name];return su?su(e):tru"
+"e;");
fastco_s.fasl=new Function("e",""
+"var fastco_s=s_c_il["+fastco_s._in+"],f=fastco_s.fa,a=f.va,l=fastco_s.wd.location,ip=fastco_s.trackPag"
+"eName,p=fastco_s.pageName;if(a[1]!=''&&a[3]!=''){a[0]=!p&&ip?l.host+l.path"
+"name:a[0]?a[0]:p;if(!f.uc&&a[3]!='No Data Entered'){if(e=='e')a[2]="
+"'Error';else if(e=='s')a[2]='Success';else a[2]='Abandon'}else a[2]"
+"='';var tp=ip?a[0]+':':'',t3=e!='s'?':('+a[3]+')':'',ym=!f.uc&&a[3]"
+"!='No Data Entered'?tp+a[1]+':'+a[2]+t3:tp+a[1]+t3,ltv=fastco_s.linkTrackV"
+"ars,lte=fastco_s.linkTrackEvents,up=fastco_s.usePlugins;if(f.uc){fastco_s.linkTrackVars="
+"ltv=='None'?f.vu+',events':ltv+',events,'+f.vu;fastco_s.linkTrackEvents=lt"
+"e=='None'?f.vl:lte+','+f.vl;f.cnt=-1;if(e=='e')fastco_s.events=fastco_s.pt(f.vl,'"
+",','fage',2);else if(e=='s')fastco_s.events=fastco_s.pt(f.vl,',','fage',1);else s"
+".events=fastco_s.pt(f.vl,',','fage',0)}else{fastco_s.linkTrackVars=ltv=='None'?f."
+"vu:ltv+','+f.vu}s[f.vu]=ym;fastco_s.usePlugins=false;var faLink=new Object"
+"();faLink.href='#';fastco_s.tl(faLink,'o','Form Analysis');s[f.vu]='';fastco_s.us"
+"ePlugins=up}return f.ul&&e!='e'&&e!='s'?f.ul(e):true;");
fastco_s.fam=new Function("e",""
+"var fastco_s=s_c_il["+fastco_s._in+"],f=fastco_s.fa;if(!e) e=fastco_s.wd.event;var o=fastco_s.trackLas"
...
+"d(e);");
fastco_s.ee=new Function("e","n",""
+"return n&&n.toLowerCase?e.toLowerCase()==n.toLowerCase():false;");
fastco_s.fage=new Function("e","a",""
+"var fastco_s=this,f=fastco_s.fa,x=f.cnt;x=x?x+1:1;f.cnt=x;return x==a?e:'';");
...
*/
fastco_s.handlePPVevents=new Function("",""
+"if(!fastco_s.getPPVid)return;var dh=Math.max(Math.max(fastco_s.d.body.scrollHeigh"
+"t,fastco_s.d.documentElement.scrollHeight),Math.max(fastco_s.d.body.offsetHeight,"
+"fastco_s.d.documentElement.offsetHeight),Math.max(fastco_s.d.body.clientHeight,fastco_s."
+"d.documentElement.clientHeight)),vph=fastco_s.wd.innerHeight||(fastco_s.d.documen"
+"tElement.clientHeight||fastco_s.d.body.clientHeight),st=fastco_s.wd.pageYOffset||"
+"(fastco_s.wd.document.documentElement.scrollTop||fastco_s.wd.document.body.scroll"
+"Top),vh=st+vph,pv=Math.min(Math.round(vh/dh*100),100),c=fastco_s.c_r('s_pp"
+"v'),a=(c.indexOf(',')>-1)?c.split(',',4):[],id=(a.length>0)?(a[0]):"
+"escape(fastco_s.getPPVid),cv=(a.length>1)?parseInt(a[1]):(0),p0=(a.length>"
+"2)?parseInt(a[2]):(pv),cy=(a.length>3)?parseInt(a[3]):(0),cn=(pv>0)"
+"?(id+','+((pv>cv)?pv:cv)+','+p0+','+((vh>cy)?vh:cy)):'';fastco_s.c_w('s_pp"
+"v',cn);");
fastco_s.getPercentPageViewed=new Function("pid",""
+"pid=pid?pid:'-';var s=this,ist=!fastco_s.getPPVid?true:false;if(typeof(fastco_s.l"
+"inkType)!='undefined'&&fastco_s.linkType!='e')return'';var v=fastco_s.c_r('s_ppv'"
+"),a=(v.indexOf(',')>-1)?v.split(',',4):[];if(a.length<4){for(var i="
+"3;i>0;i--){a[i]=(i<a.length)?(a[i-1]):('');}a[0]='';}a[0]=unescape("
+"a[0]);fastco_s.getPPVpid=pid;fastco_s.c_w('s_ppv',escape(pid));if(ist){fastco_s.getPPVid"
+"=(pid)?(pid):(fastco_s.pageName?fastco_s.pageName:document.location.href);fastco_s.c_w('"
+"s_ppv',escape(fastco_s.getPPVid));if(fastco_s.wd.addEventListener){fastco_s.wd.addEventL"
+"istener('load',fastco_s.handlePPVevents,false);fastco_s.wd.addEventListener('scro"
+"ll',fastco_s.handlePPVevents,false);fastco_s.wd.addEventListener('resize',fastco_s.handl"
+"ePPVevents,false);}else if(fastco_s.wd.attachEvent){fastco_s.wd.attachEvent('onlo"
+"ad',fastco_s.handlePPVevents);fastco_s.wd.attachEvent('onscroll',fastco_s.handlePPVevent"
+"s);fastco_s.wd.attachEvent('onresize',fastco_s.handlePPVevents);}}return(pid!='-'"
+")?(a):(a[1]);");

/* WARNING: Changing any of the below variables will cause drastic
changes to how your visitor data is collected.  Changes should only be
made when instructed to do so by your account manager.*/
// fastco_s.trackingServer="stats.fastcompany.com"
fastco_s.trackingServer="grunerandjahr.112.2o7.net"
fastco_s.dc=112
fastco_s.vmk="475EF8B1"
